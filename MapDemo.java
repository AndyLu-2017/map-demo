...
public class MapDemo {
	...
	/*
	 * Iterate through the entries in the map and print them out using
	 * the forEach() method.
	 *
	 * This uses a construct called a "lambda function" which is basically
	 * a function defined on the spot for one-time use without going
	 * through all of the formalities of writing a separate method.
	 */
